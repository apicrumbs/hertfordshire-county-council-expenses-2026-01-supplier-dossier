---
- title: "Hertfordshire County Council - Expenses - January 2026 - Supplier Dossier: HOME FROM HOME KINDERGARDEN"
- entity_id: "HOME FROM HOME KINDERGARDEN"
- category: "Transparency"
- recipe_id: "transparency/expenses"
- recipe_version: "1.0.1"
- generated_by: "ApiCrumbs_Foundry_v2"
- last_updated: "2026-05-12T14:30:12+00:00"
- status: "Grounded_Truth"
- schema: "v2.0-Alpha"
---

# TRANSPARENCY REGISTRY
## TRAIL: HOME FROM HOME KINDERGARDEN
### GET /finance/supplier/financial-pulse
- **Total Monthly Spend**: £29,342.00
- **Invoice Frequency**: 6 payments processed
- **Mean Transaction Value**: £4,890.33
---
...
| :--- | :--- | :--- | :--- |
| `*****` | Children's Services | £29,342 | 100.0% |
---
...
- Paid £500 to HOME FROM HOME KINDERGARDEN ( Children's Services)
- Paid £2436 to HOME FROM HOME KINDERGARDEN ( Children's Services)
- Paid £1290 to HOME FROM HOME KINDERGARDEN ( Children's Services)
- Paid £12232 to HOME FROM HOME KINDERGARDEN ( Children's Services)
- Paid £12384 to HOME FROM HOME KINDERGARDEN ( Children's Services)
- Paid £500 to HOME FROM HOME KINDERGARDEN ( Children's Services)
---
